...
export const processFlyerImage = async (req, res) => {
  ...
  try {
    ...
    const extractedProducts = await extractProductsFromImage(cloudinaryUrl, storeId, flyerBookId, postId, imageId);
    ...
    logger.error('[FlyerController] Error processing flyer:', error);
